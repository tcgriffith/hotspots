...
subprocess.call("bedtools getfasta -tab -fi /export/home/s5029518/aspen/dataset/vepdata/Homo_sapiens.GRCh37.75.dna.primary_assembly.fa -bed ___tmp.bed -fo ___tmp.tsv".split(" "))
